...
public class GroupsPublicGroupsFragment extends Fragment {
    ...
    public static GroupsPublicGroupsFragment newInstance(String param1, String param2) {
        GroupsPublicGroupsFragment fragment = new GroupsPublicGroupsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_groups_public_groups, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        View view3 = view;
        RecyclerView recyclerView = (RecyclerView) view3.findViewById(R.id.groupsSubPublicGroupsRecyclerView);
