...
public class MyGroupSubMySpotsFragment extends Fragment {
    ...
    public static MyGroupSubMySpotsFragment newInstance(String param1, String param2) {
        MyGroupSubMySpotsFragment fragment = new MyGroupSubMySpotsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_my_group_sub_my_spots, container, false);
    }

    public void onViewCreated(View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        SpotsListAdapter listAdapter = new SpotsListAdapter(new SpotsListAdapter.WordDiff(),getContext());
        RecyclerView recyclerView =  view.findViewById(R.id.myGroupSubMySpotsRecyclerView);
