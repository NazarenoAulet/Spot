...
public class ParticularGroupSubSpotsFragment extends Fragment {
    ...
    public static ParticularGroupSubSpotsFragment newInstance(String param1, String param2) {
        ParticularGroupSubSpotsFragment fragment = new ParticularGroupSubSpotsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_particular_group_sub_spots, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) view2.findViewById(R.id.particularGroupSubSpotsRecyclerView);
