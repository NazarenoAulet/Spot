...
public class BelongGroupSubSpotsFragment extends Fragment {
    ...
    public static BelongGroupSubSpotsFragment newInstance(String param1, String param2) {
        BelongGroupSubSpotsFragment fragment = new BelongGroupSubSpotsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_belong_group_sub_spots, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) view2.findViewById(R.id.belongGroupSubSpotsRecyclerView);
