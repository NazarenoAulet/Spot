...
public class UserSubSpotsFragment extends Fragment {
    ...
    public static UserSubSpotsFragment newInstance(String param1, String param2) {
        UserSubSpotsFragment fragment = new UserSubSpotsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_user_sub_spots, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) view2.findViewById(R.id.userSubSpotsRecyclerView);
