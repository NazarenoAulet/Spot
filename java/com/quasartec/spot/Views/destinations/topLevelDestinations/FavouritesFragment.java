...
import com.quasartec.spot.adapters.listAdapters.pagerAdapters.FavouritesPagerAdapter;
...
public class FavouritesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ViewPager viewPager=view.findViewById(R.id.viewPagesFavourites);
        FavouritesPagerAdapter pagerAdapter= new FavouritesPagerAdapter(getChildFragmentManager());
        viewPager.setAdapter(pagerAdapter);

        TabLayout tabLayout= view.findViewById(R.id.tabLayoutFavourites);
